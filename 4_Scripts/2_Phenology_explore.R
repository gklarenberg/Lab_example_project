...
jpeg("Phenology_OSBS/5_Outputs/01_pheno_stack.jpg", width = 720, height = 510)
pheno_stack
dev.off()

jpeg("Phenology_OSBS/5_Outputs/02_pheno_group.jpg", width = 720, height = 510)
pheno_group
dev.off()

jpeg("Phenology_OSBS/5_Outputs/03_pheno_stack_percent.jpg", width = 720, height = 510)
pheno_percent_bar
dev.off()

jpeg("Phenology_OSBS/5_Outputs/04_pheno_point_month.jpg", width = 720, height = 510)
pheno_point2
dev.off()
