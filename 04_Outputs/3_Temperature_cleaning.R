...
############# 2 Load data ####################
# Read in raw data
temp30 <- read_csv("01_Raw_data/SAAT_30min.csv")
...
############# 5 Save cleaned data ####################
# Save data 
write_csv(temp30_noNA, "02_Clean_data/temp30_clean_OSBS.csv")
...
write_csv(temp30_daily, "02_Clean_data/temp_daily_clean_OSBS.csv")
...
############# 7 Save plots ####################
jpeg("05_Outputs/05_temp_plot.jpg", width = 720, height = 504)
temp_plot1
dev.off()

jpeg("05_Outputs/06_temp_daily_plot.jpg", width = 720, height = 504)
temp_plot2
dev.off()
